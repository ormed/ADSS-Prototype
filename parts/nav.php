<!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><i class="fa fa-ambulance"></i> Prototype | <font color="green" style="font-family: Cursive">Welcome <?php //echo $_SESSION['user']?>!</font></a>
            </div>
            <!-- /.navbar-header -->
