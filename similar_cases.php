                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">Transplantation
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="">HDU
                                                </label>
                                            </div>
                                        </div>     
                                        <div class="form-group">
                                            <label>Past Transplantation</label>
                                        ...
                                        <div class="form-group">
                                            <label>Age</label>
                                            <input class="form-control" maxlength="3" onkeypress='return event.charCode >= 46 && event.charCode <= 57'>
                                        </div>
