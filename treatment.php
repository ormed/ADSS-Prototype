                        ...
                        <div class="col-lg-6">
                            <form role="form" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="new_first_name"
                                           value="<?php if (isset($_POST['new_first_name'])) echo $_POST['new_first_name']; ?>">
                                </div>
                                <div class="form-group">
                                    <i class="fa fa-caret-right"></i> <label>Last Name</label>
                                    <input class="form-control" name="new_last_name"
                                           value="<?php if (isset($_POST['new_last_name'])) echo $_POST['new_last_name']; ?>">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <form role="form" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="option_cust" name="customer" class="form-control" style="width:200px"
                                            onchange="showDetails()">
                                        <?php foreach ($results as $result) { ?>
                                            <option
                                                value='<?php echo($result['CUST_ID'] . "," . $result['FIRST_NAME'] . "," . $result['LAST_NAME']); ?>'><?php echo($result['FIRST_NAME'] . " " . $result['LAST_NAME']); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id='edit_last_name' name="last_name"
                                           placeholder='Edit Last Name' value='<?php echo $results[0]['LAST_NAME']; ?>'>
                                </div>
